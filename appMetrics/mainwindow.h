...
public slots:
    ...
    // EXO TP
    void editThermalErosion();
    void editHydraulicErosion();

    void updateTrafficSimulation();
...
private:
    ...
    // EXO TP
    void editVegetationCompute();
    void editVegetationStep();
    void editVegetationReset();

    ScalarField2 vegP; 
    ScalarField2 vegV;  

    bool vegInitialized = false;

    Vector3 roadStartPoint;
    Vector3 roadEndPoint;
    bool selectingRoadStart = true; 
    std::vector<Vector3> currentRoadPath; 

    void drawRoadOnTexture(); 
